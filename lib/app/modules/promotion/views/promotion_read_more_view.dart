...
class PromotionReadMoreView extends GetView<PromotionController> {
  final PromotionController controller = Get.find();
  PromotionReadMoreView({Key? key}) : super(key: key);
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                "Author: ${controller.postDetails.child("userName").value.toString()}",
