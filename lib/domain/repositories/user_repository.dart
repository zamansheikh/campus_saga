...
abstract class UserRepository {
  ...
  Future<Either<Failure, List<String>>> uploadVerificationImages(String userId, List<File> image);
  Future<Either<Failure, Verification>> varificationRequest(Verification verification);
  Future<Either<Failure, List<Verification>>> getPendingVerificaionByUniversity(String universityId);
  Future<Either<Failure, void>> updateVerificationStatus(Verification verification);
}
